...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Home/css/jquery.range.css">
                        ...
                        <div class="col-lg-9 col-md-12">
                            ...
                            <div class="actions">
                                <div class="actionstitle">
                                    <h3><img src="Home/images/resources/icon1.png" alt="image"> Popular Actions</h3>
                                    <hr>
                                </div>
                            ...
                            <div class="actions">
                                <div class="actionstitle">
                                    <h3><img src="Home/images/resources/icon2.png" alt="image"> Suggested for you</h3>
                                    <hr>
                                </div>
                                <div class="actionstext">
                                    <div class="row">
                            ...
                            <!-- endactione -->
                            <div class="helpform">
                                <img src="Home/images/resources/formicon.png" alt="image">
                                <h3>Help Forum</h3>
...
<script type="text/javascript" src="Home/js/jquery.range-min.js"></script>
