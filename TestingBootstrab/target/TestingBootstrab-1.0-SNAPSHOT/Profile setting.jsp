    ...
    <header>
        <div class="container">
            <div class="header-data">
                <div class="logo">
                    <a href="index.html" title=""><img src="Home/Home/images/logo.png" alt=""></a>
                </div><!--logo end-->
                    ...
                    <ul>
                        <li>
                            <a href="index.html" title="">
                                <span><img src="Home/Home/images/icon1.png" alt=""></span>
                                Home
                            </a>
                        </li>
                        <li>
                            <a href="companies.html" title="">
                                <span><img src="Home/Home/images/icon2.png" alt=""></span>
                                Companies
                            </a>
                            <ul>
                        ...
                        <li>
                            <a href="projects.html" title="">
                                <span><img src="Home/Home/images/icon3.png" alt=""></span>
                                Projects
                            </a>
                        </li>
                        <li>
                            <a href="profiles.html" title="">
                                <span><img src="Home/Home/images/icon4.png" alt=""></span>
                                Profiles
                            </a>
                            <ul>
                        ...
                        <li>
                            <a href="jobs.html" title="">
                                <span><img src="Home/Home/images/icon5.png" alt=""></span>
                                Jobs
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#" title="" class="not-box-open">
                                <span><img src="Home/Home/images/icon7.png" alt=""></span>
                                Notification
                            </a>
                                ...
                                <div class="nott-list">
                                    <div class="notfication-details">
                                        <div class="noty-user-img">
                                            <img src="Home/Home/images/resources/ny-img1.png" alt="">
                                        </div>
                                    ...
                                    <div class="notfication-details">
                                        <div class="noty-user-img">
                                            <img src="Home/Home/images/resources/ny-img2.png" alt="">
                                        </div>
                                        <div class="notification-info">
                                            <h3><a href="#" title="">Jassica William</a> Comment on your project.</h3>
                                            <span>2 min ago</span>
                                    ...
                                    <div class="notfication-details">
                                        <div class="noty-user-img">
                                            <img src="Home/Home/images/resources/ny-img3.png" alt="">
                                        </div>
                                        <div class="notification-info">
                                            <h3><a href="#" title="">Jassica William</a> Comment on your project.</h3>
                                            <span>2 min ago</span>
                ...
                <div class="user-account">
                    <div class="user-info">
                        <img src="Home/Home/images/resources/user.png" alt="">
                        <a href="#" title="">John</a>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <div class="profile-bx-info">
                                                    <div class="pro-bx">
                                                        <img src="Home/Home/images/pro-icon1.png" alt="">
                                                        <div class="bx-info">
                                                            <h3>$5,145</h3>
                                                            <h5>Total Income</h5>
                                                        </div><!--bx-info end-->
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <div class="profile-bx-info">
                                                    <div class="pro-bx">
                                                        <img src="Home/Home/images/pro-icon2.png" alt="">
                                                        <div class="bx-info">
                                                            <h3>$4,745</h3>
                                                            <h5>Widthraw</h5>
                                                        </div><!--bx-info end-->
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <div class="profile-bx-info">
                                                    <div class="pro-bx">
                                                        <img src="Home/Home/images/pro-icon3.png" alt="">
                                                        <div class="bx-info">
                                                            <h3>$1,145</h3>
                                                            <h5>Sent</h5>
                                                        </div><!--bx-info end-->
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <div class="profile-bx-info">
                                                    <div class="pro-bx">
                                                        <img src="Home/Home/images/pro-icon4.png" alt="">
                                                        <div class="bx-info">
                                                            <h3>130</h3>
                                ...
                                <div class="acc-setting">
                                    ...
                                    <div class="requests-list">
                                        <div class="request-details">
                                            <div class="noty-user-img">
                                                <img src="Home/Home/images/resources/r-img1.png" alt="">
                                            </div>
                                        ...
                                        <div class="request-details">
                                            <div class="noty-user-img">
                                                <img src="Home/Home/images/resources/r-img2.png" alt="">
                                            </div>
                                            <div class="request-info">
                                                <h3>John Doe</h3>
                                        ...
                                        <div class="request-details">
                                            <div class="noty-user-img">
                                                <img src="Home/Home/images/resources/r-img3.png" alt="">
                                            </div>
                                            <div class="request-info">
                                                <h3>Poonam</h3>
                                        ...
                                        <div class="request-details">
                                            <div class="noty-user-img">
                                                <img src="Home/Home/images/resources/r-img4.png" alt="">
                                            </div>
                                            <div class="request-info">
                                                <h3>Bill Gates</h3>
                                        ...
                                        <div class="request-details">
                                            <div class="noty-user-img">
                                                <img src="Home/Home/images/resources/r-img5.png" alt="">
                                            </div>
                                            <div class="request-info">
                                                <h3>Jessica William</h3>
                                                <span>Graphic Designer</span>
                                        ...
                                        <div class="request-details">
                                            <div class="noty-user-img">
                                                <img src="Home/Home/images/resources/r-img6.png" alt="">
                                            </div>
                                            <div class="request-info">
                                                <h3>John Doe</h3>
                                                <span>PHP Developer</span>
    ...
    <footer>
        <div class="footy-sec mn no-margin">
            <div class="container">
                ...
                <p><img src="Home/Home/images/copy-icon2.png" alt="">Copyright 2019</p>
