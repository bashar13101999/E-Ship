...
<section class="banner">
    <div class="bannerimage">
        <img src="Home/images/about.png" alt="image">
    </div>
...
<section class="Company-overview">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <img src="Home/images/about3.png" alt="image">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="blog">
                    <img src="Home/images/blog.png" alt="image">
                    <h2>Our Blog</h2>
                    <a href="#">View Blog</a>
                </div>
            </div>
            <div class="col-md-4 col-sm-12">
                <div class="blog">
                    <img src="Home/images/career.png" alt="image">
            ...
            <div class="col-md-4 col-sm-12">
                <div class="blog">
                    <img src="Home/images/forum.png" alt="image">
                    <h2>Help Forum</h2>
